(function () {
  ...
  var $t,
    ...
    It = {},
    co = [],
    Ts = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i,
    Mt = Array.isArray;
  function Ne(e, t) {
  ...
  function Un(e) {
    ((!e.__d && (e.__d = !0) && tt.push(e) && !Gt.__r++) ||
      oo != T.debounceRendering) &&
      ((oo = T.debounceRendering) || ao)(Gt);
  }
  function Gt() {
        ...
        ? ((l = a + v),
          ((i = e.__k[a] =
            ...
            i.constructor == String
              ? Dt(null, i, null, null, null)
              : Mt(i)
                ? Dt(ee, { children: i }, null, null, null)
                : i.constructor == null && i.__b > 0
                  ? Dt(i.type, i.props, i.key, i.ref ? i.ref : null, i.__v)
                  : i).__ = e),
          (i.__b = e.__b + 1),
          (s = null),
          (c = i.__i = Ps(i, n, l, u)) != -1 &&
            (u--, (s = n[c]) && (s.__u |= 2)),
          s == null || s.__v == null
            ? (c == -1 && (o > f ? v-- : o < f && v++),
  ...
  function vo(e, t, n) {
    t[0] == "-"
      ? e.setProperty(t, n ?? "")
      : (e[t] =
          n == null ? "" : typeof n != "number" || Ts.test(t) ? n : n + "px");
  }
  ...
  function Bn(e, t, n, r, o, a, i, s, l, c) {
    ...
    e: if (typeof O == "function")
      try {
        ...
        (u.state = u.__s),
          ...
          f != null &&
            f.type === ee &&
            f.key == null &&
            (M = _o(f.props.children)),
          (s = po(e, Mt(M) ? M : [M], t, n, r, o, a, i, s, l, c)),
          (u.base = t.__e),
          (t.__u &= -161),
      ...
      a == null && t.__v == n.__v
        ...
        : (s = t.__e = As(n.__e, t, n, r, o, a, i, l, c));
  ...
  function jn(e, t, n) {
    ...
    return (
      ...
      Dt(e.type, s, r || e.key, o || e.ref, null)
    );
  }
  function ie(e) {
    function t(n) {
  ...
  function Rs(e, t, n, r) {
    ...
    return (
      ...
      (o.prototype.attributeChangedCallback = Os),
      (o.prototype.disconnectedCallback = Ls),
  ...
  function A(e, t) {
    var n = nt(De++, 3);
    !Z.__s && Zn(n.__H, t) && ((n.__ = e), (n.u = t), W.__H.__h.push(n));
  }
  function Oe(e, t) {
    var n = nt(De++, 4);
    !Z.__s && Zn(n.__H, t) && ((n.__ = e), (n.u = t), W.__h.push(n));
  }
  function E(e) {
    return (
      (dt = 5),
  ...
  function B(e, t) {
    var n = nt(De++, 7);
    return Zn(n.__H, t) && ((n.__ = e()), (n.__H = t), (n.__h = e)), n.__;
  }
  function $(e, t) {
    return (
      (dt = 8),
  ...
  function Us() {
    for (var e; (e = Co.shift()); )
      if (e.__P && e.__H)
        try {
          e.__H.__h.forEach(Qt), e.__H.__h.forEach(Gn), (e.__H.__h = []);
        } catch (t) {
    ...
    (Z.__r = function (e) {
      ...
      t &&
        (qn === W
          ...
          : (t.__h.forEach(Qt), t.__h.forEach(Gn), (t.__h = []), (De = 0))),
        (qn = W);
    }),
    (Z.diffed = function (e) {
      Eo && Eo(e);
      ...
      t &&
        t.__H &&
        (t.__H.__h.length &&
          ((Co.push(t) !== 1 && xo === Z.requestAnimationFrame) ||
            ((xo = Z.requestAnimationFrame) || Bs)(Us)),
  ...
  function Vs(e) {
    ...
    (t.componentWillUnmount = function () {
      ...
      Be(K(js, { context: t.context }, e.__v), t.v);
  }
  function nn(e, t) {
    var n = K(Vs, { __v: e, h: t });
  ...
  T.event = function (e) {
    return (
      jo && (e = jo(e)),
      (e.persist = Zs),
      (e.isPropagationStopped = Js),
      (e.isDefaultPrevented = Qs),
      (e.nativeEvent = e)
    );
  };
  var ar,
    ...
    typeof e.type == "string" &&
      (function (t) {
        ...
        r == "select" &&
          ...
          (o.value = Me(n.children).forEach(function (c) {
          ...
          n.class && !n.className
            ? ((o.class = n.class), Object.defineProperty(o, "className", el))
  ...
  var nl = Symbol.for("preact-signals");
  function on() {
    if (je > 1) je--;
    else {
      ...
      if (typeof t.type == "string" && (n = t.__e)) {
        ...
        if (r) {
          ...
          for (var l in r) {
            var c = a[l],
              f = r[l];
            c === void 0 ? ((c = ol(n, l, f, o)), (a[l] = c)) : c.o(f, o);
          }
        }
      }
      e(t);
  ...
  function ll() {
    ua.push(this) === 1 && (T.requestAnimationFrame || al)(sl);
  }
  function cl() {
    oa(function () {
  ...
  function pa() {
    da.push(this) === 1 && (T.requestAnimationFrame || il)(cl);
  }
  function Ve(e) {
    var t = E(e);
    (t.current = e),
...
`
    ...
    static async create({ sampleRate: t, format: n }) {
      ...
      try {
        ...
        const a = r.createAnalyser(),
          i = r.createGain();
        i.connect(a), a.connect(r.destination), await pl(r.audioWorklet);
      ...
      super(t, n),
        ...
        (this.onInputWorkletMessage = (i) => {
          this.status === "connected" &&
            this.connection.sendMessage({
              user_audio_chunk: ul(i.data[0].buffer)
            });
        }),
  ...
  var vl = Object.defineProperty,
    ml = (e, t, n) =>
      t in e
        ...
        : (e[t] = n),
    ue = (e, t, n) => ml(e, typeof t != "symbol" ? t + "" : t, n);
  function mt(e) {
  ...
  const vr = [
    ...
    ba = ["tiny", "compact", "full"];
  function _l(e) {
    return ba.includes(e) ? e : ba[0];
  }
  const wl = [
    "top-left",
    "top",
  ...
  function yl(e) {
    return wl.includes(e) ? e : "bottom-right";
  }
  const xa = {
  ...
  function kl({ value: e, children: t }) {
    ...
    return (
      ...
      d(ka.Provider, { value: n, children: t })
    );
  }
  function Sl() {
    return Ce(ka);
  ...
  function El({ children: e }) {
    const t = Y("server-location"),
      n = B(() => {
        const r = me(() => Cl(t.value)),
          o = {
        ...
        return {
          location: r,
          serverUrl: me(() => o[r.value]),
          webSocketUrl: me(() => a[r.value])
        };
      }, []);
    return d(Sa.Provider, { value: n, children: e });
  }
  function Ea() {
    return Ce(Sa);
  }
  ...
  function Tl({ children: e }) {
    const t = le(),
      n = Y("language"),
      r = Y("override-language"),
      o = xe(n.peek() ?? t.peek().language),
      a = J(() => (t.value.supported_language_overrides ?? []).filter(mr)),
      i = J(() =>
    ...
    return d(Ta.Provider, { value: s, children: e });
  }
  function gt() {
    return Ce(Ta);
  }
  ...
  function Nl({ children: e }) {
    const t = le(),
      n = J(() => t.value.mic_muting_enabled ?? !1),
      r = xe(!1),
      o = B(
        () => ({
    ...
    return d(Na.Provider, { value: o, children: e });
  }
  function Pa() {
    return Ce(Na);
  }
  ...
  function Pl({ children: e }) {
    const { language: t } = gt(),
      n = Y("override-prompt"),
      r = Y("override-first-message"),
      o = Y("override-voice-id"),
      a = Y("override-text-only"),
      i = J(() => ({
        agent: {
    ...
    return h.value ? d(Aa.Provider, { value: h, children: e }) : null;
  }
  function Al() {
    return Ce(Aa);
  }
  ...
  function $l({ children: e }) {
    ...
    return d($a.Provider, { value: n, children: e });
  }
  function dn() {
    return Ce($a);
  }
  ...
  function Il({ children: e }) {
    ...
    return (
      ...
      d(Ia.Provider, { value: t, children: e })
    );
  }
  function de() {
    return Ce(Ia);
  ...
  function Ol({ children: e }) {
    ...
    Ve(() => {
      if (r.value)
        try {
          ...
          console.error(
            `[ConversationalAI] Cannot parse override-config: ${g == null ? void 0 : g.message}`
          );
        }
      if (!n.value) {
        o.value = null;
      ...
      return (
        Ll(n.value, t.value, h.signal)
          .then((g) => {
            h.signal.aborted || (o.value = g);
          })
          .catch((g) => {
            console.error(
              `[ConversationalAI] Cannot fetch config for agent ${n.value}: ${g == null ? void 0 : g.message}`
            ),
    ...
    return v.value ? d(Ma.Provider, { value: v, children: e }) : null;
  }
  function le() {
    return Ce(Ma);
  }
  function gr() {
    const e = Y("override-text-only"),
      t = le();
    return J(() => mt(e.value) ?? t.value.text_only ?? !1);
  }
  function fn() {
    const e = gr(),
  ...
  function Da() {
    const e = Y("override-first-message"),
      t = le(),
      { language: n } = gt();
    return J(() => {
      var r, o;
  ...
  const Rl = tn(function () {
    const e = le(),
      t = J(() => {
        const n = e.value.styles;
        return `:host, :root {
${xl.map((r) => `${Fl(r)}: ${zl((n == null ? void 0 : n[r]) ?? Ca[r])};`).join(`
`)}
}`;
      });
    return d("style", { children: [t, gl] });
  });
  function Fl(e) {
  ...
  function Ul({ children: e }) {
    ...
    return d(Oa.Provider, { value: a, children: e });
  }
  function fe() {
    return Ce(Oa);
  }
  ...
  function Bl({ children: e }) {
    const t = le(),
      n = Y("avatar-image-url"),
      r = Y("avatar-orb-color-1"),
      o = Y("avatar-orb-color-2"),
      a = xe(""),
      i = J(() =>
        n.value
    ...
    return d(La.Provider, { value: l, children: e });
  }
  function _r() {
    return Ce(La);
  }
  ...
  function pn({ children: e, ...t }) {
    ...
    return d("div", {
      ref: r,
      ...t,
      children: n && d(Ra.Provider, { value: n, children: e })
    });
  }
  function Wl() {
    return Ce(Ra);
  ...
  function Vl(e) {
    const t = I((n, r) => {
      ...
      if (Le(o)) {
        const i = Kl(o),
          s = Xl(a, o.props);
        return o.type !== ee && (s.ref = r ? Ua(r, i) : i), Lt(o, s);
      }
  ...
  function ke(e) {
    const t = Wa().value ? Gl : Zl;
    return d(t, { ...e });
  }
  function Gl({ active: e, ...t }) {
    return Fa(e) ? d(Ba, { "data-shown": !0, ...t }) : null;
  }
  function Zl({ active: e, initial: t = e, ...n }) {
    const r = Hl(e),
      o = xe(jl(t));
    Ve(() => {
    ...
    return !r.value && !o.value
      ? null
      : d(Ba, { "data-shown": r.value && o.value, ...a, ...n });
  }
...
`,
    ja = 0,
    ec = new Float32Array([-1, 1, -1, -1, 1, 1, 1, -1]),
    tc =
    ...
    Va = class et {
      constructor(t) {
        ...
        (this.gl = n), (this.program = this.setupProgram(Jl, Ql));
        ...
        n.bindBuffer(n.ARRAY_BUFFER, o),
          n.bufferData(n.ARRAY_BUFFER, ec, n.STATIC_DRAW),
          n.vertexAttribPointer(ja, 2, n.FLOAT, !1, 0, 0),
          n.enableVertexAttribArray(ja),
  ...
  ue(Va, "noiseImage");
  let nc = Va;
  const rc = { sm: "w-9 h-9", lg: "w-48 h-48" };
  function _t({ size: e = "sm", className: t }) {
    ...
    return d("div", {
      className: q("relative shrink-0", rc[e], t),
      children: [
        d("div", {
          ref: s,
        ...
        d("div", {
          ...
          children:
            i.value.type === "orb" &&
            d(oc, { color1: i.value.color_1, color2: i.value.color_2 })
        })
      ]
    });
  }
  function oc({ color1: e, color2: t }) {
  ...
  const ac = {
    ...
    ic = { sm: "text-xs", md: "text-lg" };
  function wt({ name: e, size: t = "md", className: n }) {
    const r = ac[e];
    return d("slot", {
      name: `icon-${e}`,
      className: q("flex", ic[t], n),
      "aria-hidden": !0,
      children: d(r, {})
    });
  }
  ...
  function Fe(e) {
    const t = Wa().value ? vc : mc;
    return d(t, { ...e });
  }
  function vc({ visible: e, className: t, grow: n, dep: r, ...o }) {
    return e ? d("div", { className: q(n && "grow", t), ...o }) : null;
  }
  function mc({
    visible: e,
    children: t,
    ...
    const { transitioning: g, handlers: p } = Ha({
      onEnd: () => {
  ...
  var Sc = "DismissableLayer",
    ...
    Ec = "dismissableLayer.pointerDownOutside",
    Tc = "dismissableLayer.focusOutside",
    Ya,
    Xa = ie({
      layers: new Set(),
    ...
    Ka = I((e, t) => {
      const {
        ...
        C = Ac((x) => {
          const P = x.target,
            M = [...c.branches].some((F) => F.contains(P));
          !b ||
            M ||
            (o == null || o(x),
            i == null || i(x),
        ...
        k = $c((x) => {
          const P = x.target;
          [...c.branches].some((M) => M.contains(P)) ||
            (a == null || a(x),
            i == null || i(x),
            x.defaultPrevented || s == null || s());
        }, v);
    ...
    return (
      A(() => {
        const o = (a) => {
          a.target &&
            !r.current &&
            Za(Tc, n, { originalEvent: a }, { discrete: !1 });
        };
        return (
  ...
  function Ic() {
    A(() => {
      ...
      return (
        document.body.insertAdjacentElement("afterbegin", e[0] ?? Ja()),
        document.body.insertAdjacentElement("beforeend", e[1] ?? Ja()),
        kr++,
        () => {
          kr === 1 &&
            document
      ...
      A(() => {
        if (r) {
          let p = function (y) {
              ...
              const b = y.target;
              s.contains(b) ? (u.current = b) : Ye(u.current, { select: !0 });
            },
            m = function (y) {
              if (h.paused || !s) return;
              const b = y.relatedTarget;
              b !== null && (s.contains(b) || Ye(u.current, { select: !0 }));
            },
            _ = function (y) {
              if (document.activeElement === document.body)
                for (const b of y) b.removedNodes.length > 0 && Ye(s);
            };
        ...
        A(() => {
          if (s) {
            ...
            if (!s.contains(p)) {
              const m = new CustomEvent(Sr, Qa);
              s.addEventListener(Sr, c),
                s.dispatchEvent(m),
                m.defaultPrevented ||
                  (Dc(zc(ti(s)), { select: !0 }),
                  document.activeElement === p && Ye(s));
            }
            return () => {
              s.removeEventListener(Sr, c),
                setTimeout(() => {
                  const m = new CustomEvent(Er, Qa);
                  s.addEventListener(Er, f),
                    s.dispatchEvent(m),
                    m.defaultPrevented ||
                      Ye(p ?? document.body, { select: !0 }),
      ...
      const g = $(
        (p) => {
          ...
          if (m && _) {
            ...
            y && b
              ? !p.shiftKey && _ === b
                ? (p.preventDefault(), n && Ye(y, { select: !0 }))
                : p.shiftKey &&
                  _ === y &&
                  (p.preventDefault(), n && Ye(b, { select: !0 }))
  ...
  function ni(e, t) {
    for (const n of e) if (!Lc(n, { upTo: t })) return n;
  }
  ...
  function Fc() {
    ...
    return {
      add(t) {
        const n = e[0];
        t !== n && (n == null || n.pause()), (e = oi(e, t)), e.unshift(t);
      },
      remove(t) {
        var n;
        (e = oi(e, t)), (n = e[0]) == null || n.resume();
      }
    };
  }
  function oi(e, t) {
            ...
            if (
              ...
              let R =
                (L = F.filter((j) => j.overflows[0] <= 0).sort(
                  (j, D) => j.overflows[1] - D.overflows[1]
                )[0]) == null
                  ? void 0
                  : L.placement;
              if (!R)
          ...
          switch (r) {
            case "referenceHidden": {
              const a = await Wt(t, { ...o, elementContext: "reference" }),
                i = si(a, n.reference);
              return {
                data: { referenceHiddenOffsets: i, referenceHidden: li(i) }
              };
            }
            case "escaped": {
              const a = await Wt(t, { ...o, altBoundary: !0 }),
                i = si(a, n.floating);
              return { data: { escapedOffsets: i, escaped: li(i) } };
            }
            default:
              return {};
          }
  ...
  function Ae(e) {
    var t;
    return (t = (ci(e) ? e.ownerDocument : e.document) || window.document) ==
      null
      ? void 0
      : t.documentElement;
  }
  ...
  function Ge(e) {
    ...
    const t = e.assignedSlot || e.parentNode || (ui(e) && e.host) || Ae(e);
  ...
  function vi(e, t, n) {
    let r;
    if (t === "viewport") r = fu(e, n);
    else if (t === "document") r = du(Ae(e));
    else if (Se(t)) r = pu(t, n);
    else {
      const o = pi(e);
  ...
  function _i(e, t) {
    ...
    let r = gi(e, t);
    for (; r && au(r) && Fr(r); ) r = gi(r, t);
    return r && xt(r) && Fr(r) && !Mr(r) ? n : r || iu(e) || n;
  }
  ...
  function bu(e, t) {
    ...
    function i(s, l) {
      ...
      function b(C) {
        ...
        k === 1 && !wi(c, e.getBoundingClientRect()) && i(), (y = !1);
      }
      try {
  ...
  function xu(e, t, n, r) {
    ...
    function m() {
      const _ = ot(e);
      p && !wi(p, _) && n(), (p = _), (g = requestAnimationFrame(m));
    }
    return (
      n(),
      () => {
  ...
  function Au(e) {
    ...
    const [g, p] = S(null),
      [m, _] = S(null),
      w = $((D) => {
        D !== k.current && ((k.current = D), p(D));
      }, []),
      y = $((D) => {
        D !== x.current && ((x.current = D), _(D));
      }, []),
      b = a || g,
      C = i || m,
      k = E(null),
      ...
      X = $(() => {
        ...
        const D = { placement: t, strategy: n, middleware: v };
        O.current && (D.platform = O.current),
          Pu(k.current, x.current, D).then((V) => {
    ...
    bn(() => {
      c === !1 &&
        ...
        ((P.current.isPositioned = !1), u((D) => ({ ...D, isPositioned: !1 })));
    }, [c]);
    const z = E(!1);
    bn(
      () => (
    ...
    const ne = B(
      ...
      j = B(() => {
        ...
        const V = xi(R.floating, f.x),
          he = xi(R.floating, f.y);
        return s
          ? {
              ...D,
              transform: "translate(" + V + "px, " + he + "px)",
              ...(bi(R.floating) >= 1.5 && { willChange: "transform" })
            }
  ...
  const $u = (e) => {
      ...
      return {
        ...
        fn(n) {
          ...
          return r && t(r)
            ? r.current != null
              ? yi({ element: r.current, padding: o }).fn(n)
              : {}
            : r
              ? yi({ element: r, padding: o }).fn(n)
              : {};
        }
      };
    },
    Iu = (e, t) => ({ ...Cu(e), options: [e, t] }),
    Mu = (e, t) => ({ ...ku(e), options: [e, t] }),
    Du = (e, t) => ({ ...Nu(e), options: [e, t] }),
    Ou = (e, t) => ({ ...Su(e), options: [e, t] }),
    Lu = (e, t) => ({ ...Eu(e), options: [e, t] }),
    Ru = (e, t) => ({ ...Tu(e), options: [e, t] }),
    Fu = (e, t) => ({ ...$u(e), options: [e, t] });
  var zu = "Arrow",
    Ci = I((e, t) => {
  ...
  var Ur = "Popper",
    ...
    Ti = (e) => {
      const { __scopePopper: t, children: n } = e,
        [r, o] = S(null);
      return d(Wu, { scope: t, anchor: r, onAnchorChange: o, children: n });
    };
  Ti.displayName = Ur;
  var Ni = "PopperAnchor",
    Pi = I((e, t) => {
  ...
  var Br = "PopperContent",
    ...
    Ai = I((e, t) => {
      ...
      const {
        ...
        D = j.length > 0,
        V = { padding: R, boundary: j.filter(qu), altBoundary: D },
        {
          refs: he,
          floatingStyles: st,
          placement: qt,
          ...
          whileElementsMounted: (...ye) =>
            xu(...ye, { animationFrame: y === "always" }),
          elements: { reference: k.anchor },
          middleware: [
            Iu({ mainAxis: f + z, alignmentAxis: v }),
            g &&
              Mu({
                mainAxis: !0,
                crossAxis: !1,
                limiter: _ === "partial" ? Du() : void 0,
                ...V
              }),
            g && Ou({ ...V }),
            Lu({
              ...
              apply: ({
                ...
                const { width: Xf, height: Kf } = Yt.reference,
                  On = ye.floating.style;
                On.setProperty("--radix-popper-available-width", `${Xt}px`),
                  On.setProperty("--radix-popper-available-height", `${Kt}px`),
                  On.setProperty("--radix-popper-anchor-width", `${Xf}px`),
                  On.setProperty("--radix-popper-anchor-height", `${Kf}px`);
              }
            }),
            F && Fu({ element: F, padding: h }),
            Yu({ arrowWidth: X, arrowHeight: z }),
            w && Ru({ strategy: "referenceHidden", ...V })
          ]
        }),
        [lt, ct] = Mi(qt),
        N = rt(b);
      ...
      const G = (n = we.arrow) == null ? void 0 : n.x,
  ...
  Ai.displayName = Br;
  var $i = "PopperArrow",
    Vu = { top: "bottom", right: "left", bottom: "top", left: "right" },
    Ii = I(function (e, t) {
  ...
  Di.displayName = Ju;
  var Qu = ra[" useInsertionEffect ".trim().toString()] || pe;
  function Oi({ prop: e, defaultProp: t, onChange: n = () => {}, caller: r }) {
    const [o, a, i] = ed({ defaultProp: t, onChange: n }),
      s = e !== void 0,
      l = s ? e : o;
    {
      const f = E(e !== void 0);
  ...
  var Li = Object.freeze({
    ...
    rd = "VisuallyHidden",
    od = I((e, t) =>
      d(te.span, { ...e, ref: t, style: { ...Li, ...e.style } })
    );
  od.displayName = rd;
  var ad = function (e) {
  ...
  var Sn = "right-scroll-bar-position",
    ...
    ud = "with-scroll-bars-hidden",
    dd = "--removed-body-scroll-bar-size";
  function Hr(e, t) {
  ...
  var pd = typeof window < "u" ? Oe : A,
    zi = new WeakMap();
  function hd(e, t) {
    var n = fd(null, function (r) {
  ...
  var Cd = function () {
    ...
    Td = function (e) {
      if ((e === void 0 && (e = "margin"), typeof window > "u")) return Sd;
      var t = Ed(e),
...
`
    ...
    $d = function (e) {
      ...
      return K(Nd, { styles: Pd(a, !t, o, n ? "" : "!important") });
    },
    qr = !1;
  if (typeof window < "u")
    try {
  ...
  var Et = qr ? { passive: !1 } : !1,
    ...
    qi = function (e, t) {
      return e === "v" ? Md(t) : Dd(t);
    },
    Yi = function (e, t) {
      return e === "v" ? Od(t) : Ld(t);
    },
    Rd = function (e, t) {
      return e === "h" && t === "rtl" ? -1 : 1;
    },
    Fd = function (e, t, n, r, o) {
      var a = Rd(e, window.getComputedStyle(t).direction),
        i = a * r,
        s = n.target,
        l = t.contains(s),
        c = !1,
...
`
  ...
  function Wd(e) {
      ...
      A(
        function () {
          if (e.inert) {
            ...
            var p = cd([e.lockRef.current], (e.shards || []).map(Ki)).filter(
              Boolean
            );
            return (
    ...
    var s = $(function (p, m) {
        ...
        if (
          ...
          return !0;
        var M = r.current || C;
        return Fd(M, m, p, M === "h" ? y : b);
      }, []),
      l = $(function (p) {
        var m = p;
        if (!(!Tt.length || Tt[Tt.length - 1] !== a)) {
          var _ = "deltaY" in m ? Xi(m) : Pn(m),
      ...
      u = $(function (p) {
        c(p.type, Xi(p), p.target, s(p, e.lockRef.current));
      }, []),
      v = $(function (p) {
    ...
    return K(
      ee,
      null,
      g ? K(a, { styles: Ud(o) }) : null,
      h ? K($d, { gapMode: e.gapMode }) : null
    );
  }
  function Hd(e) {
  ...
  const jd = _d(Bi, Wd);
  var Gi = I(function (e, t) {
    return K(Tn, Ie({}, e, { ref: t, sideCar: jd }));
  });
  Gi.classNames = Tn.classNames;
  var Vd = [" ", "Enter", "ArrowUp", "ArrowDown"],
    qd = [" ", "Enter"],
    at = "Select",
    [An, $n, Yd] = wc(at),
    [Nt, Gf] = xr(at, [Yd, Si]),
    ...
    Zi = (e) => {
      const {
        ...
        [b, C] = S(!1),
        k = bc(c),
        [x, P] = Oi({ prop: r, defaultProp: o ?? !1, onChange: a, caller: at }),
        [M, F] = Oi({ prop: i, defaultProp: s, onChange: l, caller: at }),
        O = E(null),
    ...
    Qi = I((e, t) => {
      ...
      return d(Ku, {
        ...
        children: d(te.button, {
          ...
          "data-placeholder": ws(i.value) ? "" : void 0,
          ...o,
          ref: l,
    ...
    Zd = I((e, t) => {
      ...
      return (
        ...
        d(te.span, {
          ...
          children: ws(l.value) ? d(ee, { children: i }) : a
        })
      );
    });
  Zd.displayName = es;
  ...
  ts.displayName = Jd;
  var Qd = "SelectPortal",
    ns = (e) => d(Di, { asChild: !0, ...e });
  ns.displayName = Qd;
  var it = "SelectContent",
    rs = I((e, t) => {
      const n = Ze(it, e.__scopeSelect),
        [r, o] = S();
      if (
        (pe(() => {
  ...
  var Te = 10,
    [os, Je] = Nt(it),
    ef = "SelectContentImpl",
    tf = Bt("SelectContent.RemoveScroll"),
    as = I((e, t) => {
      const {
          __scopeSelect: n,
      ...
      const R = $(
          (N) => {
            const [G, ...re] = L().map((ae) => ae.ref.current),
              [U] = re.slice(-1),
      ...
      const { onOpenChange: D, triggerPointerDownPosRef: V } = w;
      A(() => {
        if (y) {
          let N = { x: 0, y: 0 };
          const G = (U) => {
      ...
      const [he, st] = ys((N) => {
          const G = L().filter((Q) => !Q.disabled),
            re = G.find((Q) => Q.ref.current === document.activeElement),
            U = bs(G, N, re);
        ...
        we = $(
          (N, G, re) => {
            const U = !ne.current && !re;
            ((w.value !== void 0 && w.value === G) || U) && O(N);
          },
          [w.value]
        ),
        lt = r === "popper" ? Yr : is,
        ...
        children: d(Gi, {
          ...
          children: d(ei, {
            ...
            onUnmountAutoFocus: oe(o, (N) => {
              var G;
              (G = w.trigger) == null || G.focus({ preventScroll: !0 }),
                N.preventDefault();
            }),
            children: d(Ka, {
              asChild: !0,
              ...
              children: d(lt, {
                ...
                onKeyDown: oe(_.onKeyDown, (N) => {
                  const G = N.ctrlKey || N.altKey || N.metaKey;
                  if (
                    (N.key === "Tab" && N.preventDefault(),
                    !G && N.key.length === 1 && st(N.key),
  ...
  as.displayName = ef;
  var nf = "SelectItemAlignedPosition",
    is = I((e, t) => {
        ...
        y = $(() => {
          if (a.trigger && a.valueNode && s && c && p && m && _) {
            const x = a.trigger.getBoundingClientRect(),
              ...
              M = a.valueNode.getBoundingClientRect(),
            ...
            if (a.dir !== "rtl") {
              const U = F.left - P.left,
                ...
                ae = x.left - Q,
                ye = x.width + ae,
                Yt = Math.max(ye, P.width),
                Xt = window.innerWidth - Te,
                Kt = qa(Q, [Te, Math.max(Te, Xt - Yt)]);
              (s.style.minWidth = ye + "px"), (s.style.left = Kt + "px");
            } else {
              const U = P.right - F.right,
                Q = window.innerWidth - M.right - U,
                ae = window.innerWidth - x.right - Q,
                ye = x.width + ae,
                Yt = Math.max(ye, P.width),
                Xt = window.innerWidth - Te,
                Kt = qa(Q, [Te, Math.max(Te, Xt - Yt)]);
            ...
            if (G <= we) {
              ...
              s.style.bottom = "0px";
              const Q = c.clientHeight - p.offsetTop - p.offsetHeight,
                ae = Math.max(lt, ct + (U ? Qe : 0) + Q + j),
                ye = G + ae;
              s.style.height = ye + "px";
            } else {
              const U = O.length > 0 && m === O[0].ref.current;
              s.style.top = "0px";
              const Q = Math.max(we, ne + p.offsetTop + (U ? qt : 0) + ct) + re;
              (s.style.height = Q + "px"), (p.scrollTop = G - we + p.offsetTop);
            }
  ...
  var hf = "SelectBubbleInput",
    _s = I(({ __scopeSelect: e, value: t, ...n }, r) => {
      const o = E(null),
        a = ce(r, o),
        i = nd(t);
      return (
  ...
  function eo({ visible: e, ...t }) {
    const n = fe(),
      { isMuted: r, isMutingEnabled: o, setIsMuted: a } = Pa(),
      i = $(() => {
        a(!r.peek());
      }, [a]);
    return o.value
  ...
  function Nf({ showTranscript: e, scrollPinned: t }) {
    const [n, r] = S(""),
      o = fn(),
      { text_input_enabled: a } = le().value,
      i = fe(),
      {
        isDisconnected: s,
        status: l,
  ...
  function Pf({ entry: e, animateIn: t }) {
    const n = fe(),
      { previewUrl: r } = _r(),
      { lastId: o } = de();
    return d(ke, {
  ...
  const Af = 16;
  function $f({ scrollPinned: e, transcript: t }) {
    const n = E(null),
      r = (a) => {
        var i;
        (i = n.current) == null ||
      ...
      d("div", {
        ...
        onScroll: (a) => {
          e.value =
            ...
            a.currentTarget.scrollHeight - a.currentTarget.clientHeight - Af;
        },
        className:
    ...
    return d(ke, {
      ...
      children: d("div", {
        ...
        children: [
          ...
          d($f, { transcript: u, scrollPinned: h }),
          d(Nf, { scrollPinned: h, showTranscript: v }),
          d(ke, {
            active: !v || i.value,
            children: d("div", {
              className:
  ...
  function Df({ expanded: e, className: t, ...n }) {
    ...
    return d("div", {
      ...
      children: [
        ...
        d("div", {
          ...
          children: d(Ss, { expanded: e })
        })
      ]
    });
  }
  function Of({ expanded: e, className: t, ...n }) {
    return d("div", {
      className: q("rounded-compact-sheet flex items-center p-2", t),
      ...n,
      children: [
  ...
  function Lf({ visible: e, className: t, ...n }) {
    const r = fe(),
  ...
  function Rf({ className: e, ...t }) {
    const { isDisconnected: n } = de(),
      r = fe();
    return d("div", {
      className: q("flex flex-col p-2 rounded-sheet", e),
      ...t,
      children: [
        d("div", {
        ...
        d("div", { className: "flex items-center", children: d(Es, {}) })
      ]
    });
  }
  function Ff({ className: e, ...t }) {
    return d("div", {
      className: q("rounded-compact-sheet flex items-center p-2", e),
      ...t,
      children: [d(_t, { className: "mx-1" }), d(Es, {})]
    });
  }
  function zf({ expandable: e, expanded: t }) {
    const n = le().value.variant,
      r = dn(),
      { isDisconnected: o } = de(),
      a = $(async () => {
    ...
    return d("div", {
      ...
      children: [
        ...
        d("div", {
          ...
          children: [
            d(qe, { onClick: n, children: e.dismiss_terms }),
            d(qe, { onClick: r, variant: "primary", children: e.accept_terms })
          ]
        })
      ]
    });
  }
  function Bf({ copyText: e, children: t }) {
    const n = fe(),
      [r, o] = S(!1);
    A(() => {
      if (r) {
    ...
    return d(qe, { onClick: a, children: r ? n.copied : t });
  }
  function Wf({ sawError: e }) {
    const t = fe(),
      { error: n, lastId: r } = de(),
      o = $(() => {
        e.value = !0;
    ...
    return d("div", {
      ...
      children: [
        ...
        d("div", {
          className: "flex justify-end gap-2",
          children: [
            d(Bf, { copyText: r, children: t.copy_id }),
            d(qe, { variant: "primary", onClick: o, children: "Close" })
          ]
        })
      ]
    });
      ...
      : d("p", {
          ...
          children: [
            d("span", {
              ...
              children: "Powered by Fusion Media YYC"
            }),
            " ",
            d("a", {
  ...
  const Pt = {
    ...
    Vf = tn(function () {
      const e = xe(!1),
        ...
        { error: r } = de(),
        o = dn(),
        a = J(() => t.value.transcript_enabled || t.value.text_input_enabled),
        i = J(() =>
          q(
            "overlay !flex transition-opacity duration-200 data-hidden:opacity-0",
            jf[t.value.placement]
          )
        );
      Ve(() => {
        r.value &&
        ...
        children: [
          d(ke, {
            ...
            children: d(pn, {
              ...
              children: [
                a.value && d(Mf, { open: e }),
                d(zf, { expandable: a.value, expanded: e })
              ]
            })
          }),
          d(ke, {
            initial: !1,
            active: c,
            children: d(pn, { className: i, style: Dn, children: d(Uf, {}) })
          }),
          d(ke, {
            initial: !1,
            active: l,
            children: d(pn, {
              className: i,
              style: Dn,
              children: d(Wf, { sawError: n })
            })
          }),
          d(pn, { className: i, style: Dn, children: d(Hf, {}) })
        ]
      });
    });
  function qf(e) {
            ...
            children: d(Tl, {
              children: d(Nl, {
                children: d(Pl, {
                  children: d(Il, {
                    children: d(Ul, {
                      children: d(Bl, { children: [d(Rl, {}), d(Vf, {})] })
                    })
                  })
                })
              })
  ...
  function Yf(e = "elevenlabs-convai") {
    Rs(qf, e, [...vr], { shadow: !0 });
  }
  Yf();
})();
